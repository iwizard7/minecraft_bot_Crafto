...
enum WaypointType {
    ...
    TELEPORT_HUB("Телепорт", "teleport", 90),
    LANDMARK("Ориентир", "landmark", 50),
    DANGER_ZONE("Опасная зона", "danger", 30),
    TRADING_POST("Торговый пост", "trade", 70),
    FARM("Ферма", "farm", 60),
    MINE("Шахта", "mine", 75),
    PORTAL("Портал", "portal", 85),
    TEMPORARY("Временная", "temp", 20);
    
    private final String displayName;
    private final String defaultIcon;
    private final int priority;
    
    WaypointType(String displayName, String defaultIcon, int priority) {
